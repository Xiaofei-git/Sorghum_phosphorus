...
# specify BASH shell
#$ -S /bin/bash
#$ -N G3_noP_pooled_homerPeaks.Sorg
...
#$ -l h_rt=30:30:0
#$ -e /sonas-hs/ware/hpc_norepl/data/xwang/sorghum_encode/err/homer_peaks/G3_noP_pooled_homer.err7
#$ -o /sonas-hs/ware/hpc_norepl/data/xwang/sorghum_encode/out/homer_peaks/G3_noP_pooled_homer.out7
