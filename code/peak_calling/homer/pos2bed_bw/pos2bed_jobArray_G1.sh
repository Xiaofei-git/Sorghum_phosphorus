...
ARRAYFILE=$(awk -v line=$SGE_TASK_ID '{if (NR == line) { print $0; };}' ./pos2bed_homer_G1.dat)
...
grep -v '#' ${ARRAYFILE}.txt | cut -f 1-6 | awk -v OFS='\t' '{print $2,$3-1,$4,$1,$6,$5}' > peakBed_w_count/${ARRAYFILE}.bed
