...
# specify BASH shell
#$ -S /bin/bash
#$ -N align_markDup_chip_V3_3rd.SM
...
ARRAYFILE=$(awk -v line=$SGE_TASK_ID '{if (NR == line) { print $0; };}' ./smp_names_V3_3rd.dat)
...
scythe -a illumina_adapters_all_plus_primerIndex.fa -o sc.${ARRAYFILE}_1.fq ${ARRAYFILE}_1.fq.gz
scythe -a illumina_adapters_all_plus_primerIndex.fa -o sc.${ARRAYFILE}_2.fq ${ARRAYFILE}_2.fq.gz
...
rm -rf sc.${ARRAYFILE}_1.fq
rm -rf sc.${ARRAYFILE}_2.fq
